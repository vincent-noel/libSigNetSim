...
class TestMath(TestCase):
	...
	def testMath(self):
		...
		# data_8.getMath().setPrettyPrintMathFormula("piecewise(3, true && false, time)")
		# 
		...
		# data_9.getMath().setPrettyPrintMathFormula("piecewise(2, true || false, time)")
		...
		# data_10.getMath().setPrettyPrintMathFormula("piecewise(2, xor(true, false), time)")
		...
		# data_11.getMath().setPrettyPrintMathFormula("piecewise(2, !false, time)")
